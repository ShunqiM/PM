...
class MaskHookLogger(object):
    ...
    def compute_attentions(self, ret):
        # print('compute attentions')
        # print(self.layer_index, self.current_layer )
        if self.current_layer == self.layer_index:
            # print('attn out shape', ret.shape)
